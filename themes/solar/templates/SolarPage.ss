<html lang="en"> 
	<head> 
		...
		<% require javascript(mysite/javascript/solar.js) %>
		<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-20388422-1']);
...
<div id="wrapper"> 
  ...
  <div id="navigation"> 
  		<ul id="nav">
		<% control Menu(1) %>	  
  		<li><a id="$URLSegment" href="$Link" title="Go to the $Title.XML page" class="$LinkingMode">$MenuTitle.XML</a></li>
   	<% end_control %>
		</ul>
   </div> 
  ...
  <!-- End Navigation --> 
  <!-- Begin Left Column --> 
  <div id="leftcolumn"> <a href="home"><img src="themes/solar/images/g8-solar.gif"></a>
